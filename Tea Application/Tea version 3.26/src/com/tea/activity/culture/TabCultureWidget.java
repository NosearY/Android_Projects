...
public class TabCultureWidget extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent().setClass(this, CultureActivity1.class);
    	...
    	intent = new Intent().setClass(this, CultureActivity2.class);
    	spec = tabHost.newTabSpec("Tab2").setIndicator("茶叶知识", null).setContent(intent);
    	tabHost.addTab(spec);
    	intent = new Intent().setClass(this, CultureActivity3.class);
    	spec = tabHost.newTabSpec("Tab3").setIndicator("茶艺文化", null).setContent(intent);
    	tabHost.addTab(spec);
