...
public class TabProductWidget extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent().setClass(this, ProductActivity1.class);

        //Chinese Version
    	spec = tabHost.newTabSpec("Tab1").setIndicator("最新推荐", null).setContent(intent);
    	tabHost.addTab(spec);

    	// Do the same for the other tabs
    	intent = new Intent().setClass(this, ProductActivity2.class);
    	spec = tabHost.newTabSpec("Tab2").setIndicator("产品中心", null).setContent(intent);
    	tabHost.addTab(spec);
    	//intent = new Intent().setClass(this, ProductActivity3.class);
    	//spec = tabHost.newTabSpec("Tab3").setIndicator("物料宣传", null).setContent(intent);
    	//tabHost.addTab(spec);
